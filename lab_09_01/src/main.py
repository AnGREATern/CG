...
CANVAS_LOCATION = (0, 0, 1, 2)
PB_CLIP_LOCATION = (1, 0, 1, 2)
PB_CLOSE_POLYGON_LOCATION = (2, 0)
PB_CLOSE_CLIPPER_LOCATION = (2, 1)
PB_CLEAR_POLYGON_LOCATION = (3, 0)
PB_CLEAR_CLIPPER_LOCATION = (3, 1)
PB_CLEAR_ALL_LOCATION = (5, 0, 1, 2)
...
class Main(QMainWindow):
    ...
    def uiLayout(self) -> None:
        ...
        self.layout.addWidget(self.pb_close_clipper, *PB_CLOSE_CLIPPER_LOCATION)
        self.layout.addWidget(self.pb_clear_polygon, *PB_CLEAR_POLYGON_LOCATION)
        self.layout.addWidget(self.pb_clear_clipper, *PB_CLEAR_CLIPPER_LOCATION)
    ...
    def showTask(self) -> None:
        ...
        self.msg_box.setText(
            "Реализация алгоритма отсечения многоугольника произвольным выпуклым отсекателем"
        )
        self.msg_box.show()
    ...
    def showInstruction(self) -> None:
        ...
        self.msg_box.setText(
            "Вершины многоугольника задаются нажатием левой кнопки мыши.\n"
            + "Вершины отсекателя задаются нажатием правой кнопкой мыши.\n"
        )
        self.msg_box.show()
